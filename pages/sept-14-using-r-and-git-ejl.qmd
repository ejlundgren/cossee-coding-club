...
|
├── docs/                       # website html files. Specify in .yml (see the one for this repo) for the rendered html to go here.
│   └── analysis-tutorial.qmd
|
...
```text
master_folder/                      # Not a Github repo. This could be called "bird_ecographic_rules"
|
├── my-repo/                        # The github repo. This might be called "Bergmann_rules"
|
